...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2016 at 12:59 AM
...
--
-- Database: `dongtrungtruongsinh`
--

-- --------------------------------------------------------

--
-- Table structure for table `dtds_assets`
--

CREATE TABLE IF NOT EXISTS `dtds_assets` (
...
--
-- Dumping data for table `dtds_assets`
--

INSERT INTO `dtds_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 105, 106, 1, 'com_phocagallery', 'com_phocagallery', '{}'),
(56, 1, 107, 108, 1, 'com_jce', 'JCE', '{}'),
(57, 1, 109, 110, 1, 'com_sanpham', 'com_sanpham', '{}'),
(58, 7, 16, 17, 2, 'com_contact.category.8', 'Liên hệ công ty', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `dtds_associations`
--

CREATE TABLE IF NOT EXISTS `dtds_associations` (
...
--
-- Table structure for table `dtds_banners`
--

CREATE TABLE IF NOT EXISTS `dtds_banners` (
...
--
-- Table structure for table `dtds_banner_clients`
--

CREATE TABLE IF NOT EXISTS `dtds_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `dtds_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `dtds_banner_tracks` (
...
--
-- Table structure for table `dtds_categories`
--

CREATE TABLE IF NOT EXISTS `dtds_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtds_categories`
--

INSERT INTO `dtds_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 608, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
...
(8, 58, 1, 11, 12, 1, 'lia-n-ha-ca-ng-ty', 'com_contact', 'Liên hệ công ty', 'lia-n-ha-ca-ng-ty', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 608, '2016-11-06 15:03:37', 0, '2016-11-06 15:03:37', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_contact_details`
--

CREATE TABLE IF NOT EXISTS `dtds_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dtds_contact_details`
--

INSERT INTO `dtds_contact_details` (`id`, `name`, `alias`, `con_position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `email_to`, `default_con`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `user_id`, `catid`, `access`, `mobile`, `webpage`, `sortname1`, `sortname2`, `sortname3`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`, `version`, `hits`) VALUES
(1, 'Liên hệ ', 'lia-n-ha', '', '', '', '', '', '', '', '', '', '', '', 0, 1, 0, '0000-00-00 00:00:00', 1, '{"show_contact_category":"","show_contact_list":"","presentation_style":"","show_tags":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","articles_display_num":"","show_profile":"","show_links":"","linka_name":"","linka":false,"linkb_name":"","linkb":false,"linkc_name":"","linkc":false,"linkd_name":"","linkd":false,"linke_name":"","linke":false,"contact_layout":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":""}', 0, 8, 1, '', '', '', '', '', '*', '2016-11-06 15:03:59', 608, '', '2016-11-06 15:03:59', 0, '', '', '{"robots":"","rights":""}', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_content`
--

CREATE TABLE IF NOT EXISTS `dtds_content` (
...
--
-- Table structure for table `dtds_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `dtds_contentitem_tag_map` (
...
--
-- Table structure for table `dtds_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `dtds_content_frontpage` (
...
--
-- Table structure for table `dtds_content_rating`
--

CREATE TABLE IF NOT EXISTS `dtds_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dtds_content_types`
--

CREATE TABLE IF NOT EXISTS `dtds_content_types` (
...
--
-- Dumping data for table `dtds_content_types`
--

INSERT INTO `dtds_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `dtds_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `dtds_core_log_searches` (
...
--
-- Table structure for table `dtds_extensions`
--

CREATE TABLE IF NOT EXISTS `dtds_extensions` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=10014 ;

--
-- Dumping data for table `dtds_extensions`
--

INSERT INTO `dtds_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"eaef2bc21bd6a091d5e02e7850da37ca"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1478446488}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":1,"lastrun":1478425050,"unique_id":"73c8df45dea53c321125406b04cbc3141d730cf0","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10013, 'com_sanpham', 'component', 'com_sanpham', '', 1, 1, 0, 0, '{"name":"com_sanpham","type":"component","creationDate":"2016-09-17","author":"kent","copyright":"B\\u1ea3n quy\\u1ec1n (C) 2014. C\\u00e1c quy\\u1ec1n \\u0111\\u1ec1u \\u0111\\u01b0\\u1ee3c b\\u1ea3o v\\u1ec7.","authorEmail":"kent.dang1706t@gmail.com","authorUrl":"http:\\/\\/viseed.com","version":"CVS: 1.0.0","description":"S\\u1ea3n ph\\u1ea9m component","group":"","filename":"sanpham"}', '{"save_history":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_finder_filters`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_filters` (
...
--
-- Table structure for table `dtds_finder_links`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links` (
...
--
-- Table structure for table `dtds_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms0` (
...
--
-- Table structure for table `dtds_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dtds_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `dtds_finder_taxonomy`
--

INSERT INTO `dtds_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dtds_finder_terms`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_terms` (
...
--
-- Table structure for table `dtds_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `dtds_finder_terms_common`
--

INSERT INTO `dtds_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `dtds_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dtds_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dtds_finder_types`
--

CREATE TABLE IF NOT EXISTS `dtds_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_languages`
--

CREATE TABLE IF NOT EXISTS `dtds_languages` (
...
--
-- Dumping data for table `dtds_languages`
--

INSERT INTO `dtds_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_menu`
--

CREATE TABLE IF NOT EXISTS `dtds_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtds_menu`
--

INSERT INTO `dtds_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_PHOCAGALLERY', 'com-phocagallery', '', 'com-phocagallery', 'index.php?option=com_phocagallery', 'component', 0, 1, 1, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu.png', 0, '{}', 43, 70, 0, '', 1),
(103, 'main', 'COM_PHOCAGALLERY_CONTROLPANEL', 'com-phocagallery-controlpanel', '', 'com-phocagallery/com-phocagallery-controlpanel', 'index.php?option=com_phocagallery', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-control-panel.png', 0, '{}', 44, 45, 0, '', 1),
(104, 'main', 'COM_PHOCAGALLERY_IMAGES', 'com-phocagallery-images', '', 'com-phocagallery/com-phocagallery-images', 'index.php?option=com_phocagallery&view=phocagalleryimgs', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-gal.png', 0, '{}', 46, 47, 0, '', 1),
(105, 'main', 'COM_PHOCAGALLERY_CATEGORIES', 'com-phocagallery-categories', '', 'com-phocagallery/com-phocagallery-categories', 'index.php?option=com_phocagallery&view=phocagallerycs', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-cat.png', 0, '{}', 48, 49, 0, '', 1),
(106, 'main', 'COM_PHOCAGALLERY_THEMES', 'com-phocagallery-themes', '', 'com-phocagallery/com-phocagallery-themes', 'index.php?option=com_phocagallery&view=phocagalleryt', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-theme.png', 0, '{}', 50, 51, 0, '', 1),
(107, 'main', 'COM_PHOCAGALLERY_CATEGORYRATING', 'com-phocagallery-categoryrating', '', 'com-phocagallery/com-phocagallery-categoryrating', 'index.php?option=com_phocagallery&view=phocagalleryra', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-vote.png', 0, '{}', 52, 53, 0, '', 1),
(108, 'main', 'COM_PHOCAGALLERY_IMAGERATING', 'com-phocagallery-imagerating', '', 'com-phocagallery/com-phocagallery-imagerating', 'index.php?option=com_phocagallery&view=phocagalleryraimg', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-vote-img.png', 0, '{}', 54, 55, 0, '', 1),
(109, 'main', 'COM_PHOCAGALLERY_CATEGORYCOMMENTS', 'com-phocagallery-categorycomments', '', 'com-phocagallery/com-phocagallery-categorycomments', 'index.php?option=com_phocagallery&view=phocagallerycos', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-comment.png', 0, '{}', 56, 57, 0, '', 1),
(110, 'main', 'COM_PHOCAGALLERY_IMAGECOMMENTS', 'com-phocagallery-imagecomments', '', 'com-phocagallery/com-phocagallery-imagecomments', 'index.php?option=com_phocagallery&view=phocagallerycoimgs', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-comment-img.png', 0, '{}', 58, 59, 0, '', 1),
(111, 'main', 'COM_PHOCAGALLERY_USERS', 'com-phocagallery-users', '', 'com-phocagallery/com-phocagallery-users', 'index.php?option=com_phocagallery&view=phocagalleryusers', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-users.png', 0, '{}', 60, 61, 0, '', 1),
(112, 'main', 'COM_PHOCAGALLERY_FB', 'com-phocagallery-fb', '', 'com-phocagallery/com-phocagallery-fb', 'index.php?option=com_phocagallery&view=phocagalleryfbs', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-fb.png', 0, '{}', 62, 63, 0, '', 1),
(113, 'main', 'COM_PHOCAGALLERY_TAGS', 'com-phocagallery-tags', '', 'com-phocagallery/com-phocagallery-tags', 'index.php?option=com_phocagallery&view=phocagallerytags', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-tags.png', 0, '{}', 64, 65, 0, '', 1),
(114, 'main', 'COM_PHOCAGALLERY_STYLES', 'com-phocagallery-styles', '', 'com-phocagallery/com-phocagallery-styles', 'index.php?option=com_phocagallery&view=phocagalleryefs', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-styles.png', 0, '{}', 66, 67, 0, '', 1),
(115, 'main', 'COM_PHOCAGALLERY_INFO', 'com-phocagallery-info', '', 'com-phocagallery/com-phocagallery-info', 'index.php?option=com_phocagallery&view=phocagalleryin', 'component', 0, 102, 2, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-info.png', 0, '{}', 68, 69, 0, '', 1),
(116, 'main', 'JCE', 'jce', '', 'jce', 'index.php?option=com_jce', 'component', 0, 1, 1, 10008, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/logo.png', 0, '{}', 71, 80, 0, '', 1),
(117, 'main', 'WF_MENU_CPANEL', 'wf-menu-cpanel', '', 'jce/wf-menu-cpanel', 'index.php?option=com_jce', 'component', 0, 116, 2, 10008, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-cpanel.png', 0, '{}', 72, 73, 0, '', 1),
(118, 'main', 'WF_MENU_CONFIG', 'wf-menu-config', '', 'jce/wf-menu-config', 'index.php?option=com_jce&view=config', 'component', 0, 116, 2, 10008, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-config.png', 0, '{}', 74, 75, 0, '', 1),
(119, 'main', 'WF_MENU_PROFILES', 'wf-menu-profiles', '', 'jce/wf-menu-profiles', 'index.php?option=com_jce&view=profiles', 'component', 0, 116, 2, 10008, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-profiles.png', 0, '{}', 76, 77, 0, '', 1),
(120, 'main', 'WF_MENU_INSTALL', 'wf-menu-install', '', 'jce/wf-menu-install', 'index.php?option=com_jce&view=installer', 'component', 0, 116, 2, 10008, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-install.png', 0, '{}', 78, 79, 0, '', 1),
(121, 'main', 'COM_SANPHAM', 'com-sanpham', '', 'com-sanpham', 'index.php?option=com_sanpham', 'component', 0, 1, 1, 10013, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_sanpham/images/s_com_sanpham.png', 0, '{}', 81, 84, 0, '', 1),
(122, 'main', 'COM_SANPHAM_TITLE_SANPHAMS', 'com-sanpham-title-sanphams', '', 'com-sanpham/com-sanpham-title-sanphams', 'index.php?option=com_sanpham&view=sanphams', 'component', 0, 121, 2, 10013, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_sanpham/images/s_.png', 0, '{}', 82, 83, 0, '', 1),
(123, 'mainmenu', 'Về chúng tôi', 'va-cha-ng-ta-i', '', 'va-cha-ng-ta-i', '', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 85, 92, 0, '*', 0),
(124, 'mainmenu', 'Sản phẩm', 'sa-n-pha-m', '', 'sa-n-pha-m', 'index.php?option=com_sanpham&view=sanphams', 'component', 1, 1, 1, 10013, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 93, 94, 0, '*', 0),
(125, 'mainmenu', 'Công dụng', 'ca-ng-da-ng', '', 'ca-ng-da-ng', '', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 95, 96, 0, '*', 0),
(126, 'mainmenu', 'Cách dùng', 'ca-ch-da-ng', '', 'ca-ch-da-ng', '', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 97, 98, 0, '*', 0),
(127, 'mainmenu', 'Khuyến mãi', 'khuya-n-ma-i', '', 'khuya-n-ma-i', '', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 99, 100, 0, '*', 0),
(128, 'mainmenu', 'Liên hệ công ty', 'lia-n-ha-ca-ng-ty', '', 'lia-n-ha-ca-ng-ty', 'index.php?option=com_contact&view=contact&id=1', 'component', 1, 1, 1, 8, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"presentation_style":"","show_contact_category":"","show_contact_list":"","show_tags":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","articles_display_num":"","show_links":"","linka_name":"","linkb_name":"","linkc_name":"","linkd_name":"","linke_name":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 101, 102, 0, '*', 0),
(129, 'mainmenu', 'Thư ngỏ', 'th-nga', '', 'va-cha-ng-ta-i/th-nga', '', 'url', 1, 123, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 86, 87, 0, '*', 0),
(130, 'mainmenu', 'Quy trình sản xuất', 'quy-tra-nh-sa-n-xua-t', '', 'va-cha-ng-ta-i/quy-tra-nh-sa-n-xua-t', '', 'url', 1, 123, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 88, 89, 0, '*', 0),
(131, 'mainmenu', 'Chứng nhận chất lượng', 'cha-ng-nha-n-cha-t-l-a-ng', '', 'va-cha-ng-ta-i/cha-ng-nha-n-cha-t-l-a-ng', '', 'url', 1, 123, 2, 0, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu-anchor_rel":"","menu_image":"","menu_text":1,"menu_show":1}', 90, 91, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_menu_types`
--

CREATE TABLE IF NOT EXISTS `dtds_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dtds_menu_types`
--

INSERT INTO `dtds_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `dtds_messages`
--

CREATE TABLE IF NOT EXISTS `dtds_messages` (
...
--
-- Table structure for table `dtds_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `dtds_messages_cfg` (
...
--
-- Table structure for table `dtds_modules`
--

CREATE TABLE IF NOT EXISTS `dtds_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `dtds_modules`
--

INSERT INTO `dtds_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `dtds_modules_menu`
--

CREATE TABLE IF NOT EXISTS `dtds_modules_menu` (
...
--
-- Dumping data for table `dtds_modules_menu`
--

INSERT INTO `dtds_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `dtds_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `dtds_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_overrider`
--

CREATE TABLE IF NOT EXISTS `dtds_overrider` (
...
--
-- Table structure for table `dtds_phocagallery`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery` (
...
--
-- Table structure for table `dtds_phocagallery_categories`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_phocagallery_comments`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Table structure for table `dtds_phocagallery_fb_users`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_fb_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_phocagallery_img_comments`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_img_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_phocagallery_img_votes`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_img_votes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `imgid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Table structure for table `dtds_phocagallery_img_votes_statistics`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_img_votes_statistics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `imgid` int(11) NOT NULL DEFAULT '0',
  `count` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dtds_phocagallery_styles`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_styles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dtds_phocagallery_styles`
--

INSERT INTO `dtds_phocagallery_styles` (`id`, `title`, `alias`, `filename`, `menulink`, `type`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `language`) VALUES
...
--
-- Table structure for table `dtds_phocagallery_tags`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dtds_phocagallery_tags_ref`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_tags_ref` (
...
--
-- Table structure for table `dtds_phocagallery_user`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dtds_phocagallery_votes`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_votes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Table structure for table `dtds_phocagallery_votes_statistics`
--

CREATE TABLE IF NOT EXISTS `dtds_phocagallery_votes_statistics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `count` int(11) NOT NULL DEFAULT '0',
  `average` float(8,6) NOT NULL DEFAULT '0.000000',
...
--
-- Table structure for table `dtds_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `dtds_postinstall_messages` (
...
--
-- Dumping data for table `dtds_postinstall_messages`
--

INSERT INTO `dtds_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `dtds_redirect_links`
--

CREATE TABLE IF NOT EXISTS `dtds_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_schemas`
--

CREATE TABLE IF NOT EXISTS `dtds_schemas` (
...
--
-- Dumping data for table `dtds_schemas`
--

INSERT INTO `dtds_schemas` (`extension_id`, `version_id`) VALUES
...
--
-- Table structure for table `dtds_session`
--

CREATE TABLE IF NOT EXISTS `dtds_session` (
...
--
-- Dumping data for table `dtds_session`
--

INSERT INTO `dtds_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('93gl0sqia8rb72482a2ablhkn6', 1, 0, '1478446601', 'joomla|s:8092:"";', 608, 'kentdt'),
('l889a3u85s9109g1b4q3063g40', 0, 1, '1478448056', 'joomla|s:644:"";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `dtds_tags`
--

CREATE TABLE IF NOT EXISTS `dtds_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `dtds_tags`
--

INSERT INTO `dtds_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `dtds_template_styles`
--

CREATE TABLE IF NOT EXISTS `dtds_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtds_template_styles`
--

INSERT INTO `dtds_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'dongtrungtruongsinh', 0, '1', 'dongtrungtruongsinh - Mặc định', '');

-- --------------------------------------------------------

--
-- Table structure for table `dtds_ucm_base`
--

CREATE TABLE IF NOT EXISTS `dtds_ucm_base` (
...
--
-- Table structure for table `dtds_ucm_content`
--

CREATE TABLE IF NOT EXISTS `dtds_ucm_content` (
...
--
-- Table structure for table `dtds_ucm_history`
--

CREATE TABLE IF NOT EXISTS `dtds_ucm_history` (
...
--
-- Dumping data for table `dtds_ucm_history`
--

INSERT INTO `dtds_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 8, 6, '', '2016-11-06 15:03:37', 608, 584, 'c72d153abc3f602670d83eaa79266cc9d729a781', '{"id":8,"asset_id":58,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_contact","title":"Li\\u00ean h\\u1ec7 c\\u00f4ng ty","alias":"lia-n-ha-ca-ng-ty","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"608","created_time":"2016-11-06 15:03:37","modified_user_id":null,"modified_time":"2016-11-06 15:03:37","hits":"0","language":"*","version":null}', 0),
(2, 1, 2, '', '2016-11-06 15:03:59', 608, 1656, 'f706e4891e8a961f7e6dd2cc4455cecee6fa3ff2', '{"id":1,"name":"Li\\u00ean h\\u1ec7 ","alias":"lia-n-ha","con_position":"","address":"","suburb":"","state":"","country":"","postcode":"","telephone":"","fax":"","misc":"","image":"","email_to":"","default_con":0,"published":"1","checked_out":null,"checked_out_time":null,"ordering":1,"params":"{\\"show_contact_category\\":\\"\\",\\"show_contact_list\\":\\"\\",\\"presentation_style\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_name\\":\\"\\",\\"show_position\\":\\"\\",\\"show_email\\":\\"\\",\\"show_street_address\\":\\"\\",\\"show_suburb\\":\\"\\",\\"show_state\\":\\"\\",\\"show_postcode\\":\\"\\",\\"show_country\\":\\"\\",\\"show_telephone\\":\\"\\",\\"show_mobile\\":\\"\\",\\"show_fax\\":\\"\\",\\"show_webpage\\":\\"\\",\\"show_misc\\":\\"\\",\\"show_image\\":\\"\\",\\"allow_vcard\\":\\"\\",\\"show_articles\\":\\"\\",\\"articles_display_num\\":\\"\\",\\"show_profile\\":\\"\\",\\"show_links\\":\\"\\",\\"linka_name\\":\\"\\",\\"linka\\":false,\\"linkb_name\\":\\"\\",\\"linkb\\":false,\\"linkc_name\\":\\"\\",\\"linkc\\":false,\\"linkd_name\\":\\"\\",\\"linkd\\":false,\\"linke_name\\":\\"\\",\\"linke\\":false,\\"contact_layout\\":\\"\\",\\"show_email_form\\":\\"\\",\\"show_email_copy\\":\\"\\",\\"banned_email\\":\\"\\",\\"banned_subject\\":\\"\\",\\"banned_text\\":\\"\\",\\"validate_session\\":\\"\\",\\"custom_reply\\":\\"\\",\\"redirect\\":\\"\\"}","user_id":0,"catid":"8","access":"1","mobile":"","webpage":false,"sortname1":"","sortname2":"","sortname3":"","language":"*","created":"2016-11-06 15:03:59","created_by":"608","created_by_alias":"","modified":"2016-11-06 15:03:59","modified_by":null,"metakey":"","metadesc":"","metadata":"{\\"robots\\":\\"\\",\\"rights\\":\\"\\"}","featured":"0","xreference":"","publish_up":"0000-00-00 00:00:00","publish_down":"0000-00-00 00:00:00","version":1,"hits":null}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_updates`
--

CREATE TABLE IF NOT EXISTS `dtds_updates` (
...
--
-- Table structure for table `dtds_update_sites`
--

CREATE TABLE IF NOT EXISTS `dtds_update_sites` (
...
--
-- Dumping data for table `dtds_update_sites`
--

INSERT INTO `dtds_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1478444193, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1478444193, ''),
...
--
-- Table structure for table `dtds_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `dtds_update_sites_extensions` (
...
--
-- Dumping data for table `dtds_update_sites_extensions`
--

INSERT INTO `dtds_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `dtds_usergroups`
--

CREATE TABLE IF NOT EXISTS `dtds_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `dtds_usergroups`
--

INSERT INTO `dtds_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `dtds_users`
--

CREATE TABLE IF NOT EXISTS `dtds_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `email` (`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=609 ;

--
-- Dumping data for table `dtds_users`
--

INSERT INTO `dtds_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(608, 'Super User', 'kentdt', 'kent.dang1706@gmail.com', '$2y$10$1rgP5Ieq0fW.5zTQloHZ/ezCeEuVb3ZjVuclEYH56fWP.Zv9Nf8Ri', 0, 1, '2016-11-06 09:26:39', '2016-11-06 14:55:56', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_user_keys`
--

CREATE TABLE IF NOT EXISTS `dtds_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dtds_user_notes`
--

CREATE TABLE IF NOT EXISTS `dtds_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dtds_user_profiles`
--

CREATE TABLE IF NOT EXISTS `dtds_user_profiles` (
...
--
-- Table structure for table `dtds_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `dtds_user_usergroup_map` (
...
--
-- Dumping data for table `dtds_user_usergroup_map`
--

INSERT INTO `dtds_user_usergroup_map` (`user_id`, `group_id`) VALUES
(608, 8);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `dtds_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `dtds_utf8_conversion`
--

INSERT INTO `dtds_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `dtds_viewlevels`
--

CREATE TABLE IF NOT EXISTS `dtds_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `dtds_viewlevels`
--

INSERT INTO `dtds_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `dtds_wf_profiles`
--

CREATE TABLE IF NOT EXISTS `dtds_wf_profiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtds_wf_profiles`
--

INSERT INTO `dtds_wf_profiles` (`id`, `name`, `description`, `users`, `types`, `components`, `area`, `device`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
